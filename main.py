...
print("loading training data succeed")
...
def process_image(image):
    ...
    boxes = find_cars(image, 400, 656, 1.5, classifier, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size,
                        hist_bins)
    add_heat(heat, boxes)
    boxes = find_cars(image, 400, 656, 2, classifier, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size,
                      hist_bins)
    add_heat(heat, boxes)
...
######### videos #########
print("begin videos:")
for file_name in ["test_video.mp4","project_video.mp4"]:
